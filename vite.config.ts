...
// Multi-page app. index.html is a bare redirect to the library (the home page); the other HTML
...
//   performance.html → src/performance.tsx   (React hull performance viewer)
//
