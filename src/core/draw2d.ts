  ...
  if (beam.length > 1)
    svg.append(
      el("path", {
        ...
        fill: "none",
        stroke: COL.fore,
        "stroke-width": W_MAIN, // the result line — drawn solid and heavier than the dashed sheer-plan guide
        "stroke-linejoin": "round",
        "stroke-linecap": "round",
      }),
    );
...
export function stationHandle(
  ...
  svg.append(
    el("line", {
      ...ends,
      stroke: stationColor(si),
      "stroke-width": active ? W_ACTIVE : W_SECONDARY,
      "stroke-linecap": "round",
    }),
  );
