// Geometry-independent table interpolation and stability calculations.
// Lengths and volumes use one consistent unit system; the query API supplies SI.
import { hermiteEval, pchipSlopes } from "../core/pchip";
